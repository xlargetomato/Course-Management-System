...
echo "<script>var key = '$enckey';</script>";
    ...
    <body>
        ...
        <div class="form-container">
            <h1>تسجيل الدخول</h1>
            <input type="text" placeholder="أسم المستخدم" id="user" style="text-align:center;" class="in form-control user" /><br>
            <input type="password" placeholder="كلمة السر" id="pass" style="text-align:center;" class="in form-control pass" /><br>
            <a class="sub btn btn-success" id="btn">تسجيل الدخول</a>
            <script>
    // Get the input field
    var input = document.getElementById("pass");
    var input2 = document.getElementById("user");
