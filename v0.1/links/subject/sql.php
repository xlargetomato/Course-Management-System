...
$query8 = "INSERT INTO `options`(`status`) VALUES ('1')";
...
$res7 = mysqli_query($MM,$query7);
$res8 = mysqli_query($MM,$query8);
if(empty($res) and empty($res2) and empty($res3) and empty($res4) and empty($res6) and empty($res7)) {
      echo 'Error creating tables: ' . mysqli_error($MM) . "<br/>";
}elseif($res and $res2 and $res3 and $res4 and $res6 and $res7){
